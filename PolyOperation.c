...
node *add = NULL; // use to point addition link list
...
void left(node *one)
{
	...
	node *two = add; // now two use for traverse in partial obtained result so that left terms can be added
